...
export function SparklesPreview() {
  return (
    <div className="w-full flex flex-col flex-grow items-center justify-center overflow-hidden rounded-md mt-28">
      <h1 className="md:text-7xl text-4xl font-bold text-center text-black relative z-20">
        Stay Tuned 🚀
      </h1>
