...
import { Paragraph, Heading, Prose } from "@/components/typography";
...
export function PostLayout({ children, meta }: any) {
  return (
    <Container>
      <article>
        <header className="flex flex-col">
          ...
          >
            <Paragraph weight="semibold">{formatDate(meta.date)}</Paragraph>
          </time>
